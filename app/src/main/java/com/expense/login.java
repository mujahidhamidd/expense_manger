...
//
            ...
            Cursor cursor2 = db.rawQuery("select * from expense where date ='"+date+"'", null);
            ...
            if (cursor2 != null) {
                ...
                makeNotification("Expense Manger","Your income is "+income+"and you spent "+spending+"'");
